<template>
  <a aria-label="View source on Github" class="github-corner" href="https://github.com/nghiennet89" target="_blank">
    <svg aria-hidden="true" height="55" style="fill:#40c9c6; color:#fff;" viewBox="0 0 250 250" width="55">
      ...
      <path class="octo-arm" d="M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6
        ...
        130.6,101.9 134.4,103.2" fill="currentColor" style="transform-origin: 130px 106px;"/>
      <path class="octo-body" d="M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4
        ...
        C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" fill="currentColor"/>
    </svg>
  </a>
</template>
